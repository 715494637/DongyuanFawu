...
const ConsultationModal: React.FC<ConsultationModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-900/40 backdrop-blur-md animate-fade-in">
      ...
      {/* 模态框主体 */}
      <div className="bg-white w-[90vw] max-w-sm rounded-[2.5rem] shadow-2xl relative overflow-hidden flex flex-col items-center animate-fade-in-up transition-all duration-300 scale-100">
        ...
        <div className="w-full pt-10 pb-6 flex justify-center bg-gradient-to-b from-blue-50/50 to-transparent">
            <div className="bg-blue-50 text-blue-600 px-5 py-2.5 rounded-full flex items-center gap-2 shadow-sm border border-blue-100">
                ...
                <span className="font-black text-xs tracking-wide">扫码添加企业微信专属顾问</span>
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-xs text-slate-400 leading-relaxed font-medium">
                  添加时请注明 <span className="text-slate-600 font-bold">项目名称</span> + <span className="text-slate-600 font-bold">申请事项</span>
                </p>
              </div>
            </div>
          ) : (
