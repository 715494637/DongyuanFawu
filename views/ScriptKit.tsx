...
import { ScriptScenario } from '../types';
            ...
            <div key={s.id} className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden">
                ...
                {openId === s.id && (
                    <div className="p-6 pt-0 space-y-4 bg-slate-50/50">
                        ...
                        <button className="w-full py-3 bg-indigo-50 text-indigo-600 rounded-xl text-xs font-bold flex items-center justify-center gap-2">
                            <Copy size={14}/> 复制全套话术
                        </button>
                    </div>
                )}
